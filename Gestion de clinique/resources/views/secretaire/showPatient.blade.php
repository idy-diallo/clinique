  ...
  <section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="{{ url('showPatient') }}">Liste des fiches Patientes</a></li>
            </ul>
          </li>
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> La liste des patients</h3>
                  ...
                  <tr>
                    ...
                    <td>
                      <!--<button class="btn btn-success btn-xs">-->
                        ...
                        <a class="btn btn-success btn-xs" title="Vous allez lui ajouter un rendez-vous !" onclick="return confirm('Vous allez ajouter un rendez-vous pour ce patient')"
                            href="{{ url('add_rdvPat',$patient->id) }}">
                          rdv
                        </a>
                      ...
                      <!--<button class="btn btn-primary btn-xs">-->
                        ...
                        <a class="btn btn-primary btn-xs" title="boutton de modification !" href="{{ url('editPatient',$patient->id) }}">   
                      ...
                      <!--<button class="btn btn-danger btn-xs">-->
                        ...
                        <a class="btn btn-danger btn-xs" title="Oups boutton de suppression !!!" onclick="return confirm('Ëtes-vous sûre de vouloir supprimer cet patient')" 
                            href="{{ url('destroyPatient',$patient->id) }}"> 
