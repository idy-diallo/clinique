        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="{{ url('showRvDemander') }}">Rendez-vous demander</a></li>
            </ul>
          </li>
              ...
              <table class="table table-striped table-advance table-hover">
                ...
                @foreach($rvDem as $r)
                  ...
                  <tr>
                    ...
                    <td> {{ $r->dateRV }} </td>
                    <td> {{ $r->heureRV }} </td>
                    <td style="background-color:#FFFF00"> {{ $r->etat }} </td>

                    <td>
                      
                      <!--<button class="btn btn-success btn-xs">-->
                        <a class="btn btn-success btn-xs" title="button de confirmation..." onclick="return confirm('Voulez-vous confirmé le rendez-vous')" 
                      ...
                      <!--<button class="btn btn-danger btn-xs">-->
                        ...
                        <a class="btn btn-danger btn-xs" title="Oups!!! button de rejet..." onclick="return confirm('Ëtes-vous sûre de vouloir rejeter ce rendez-vous')" 
                            href="{{ url('rejetRv',$r->numRDV) }}"> 
                            <i>Rejeter</i>
                        </a> 
