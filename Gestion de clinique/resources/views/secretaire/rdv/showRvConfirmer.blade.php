      ...
      <div id="sidebar" class="nav-collapse">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active"><a href="{{ url('showRvConfirmer') }}">Consulter la liste des rendez-vous</a></li>
              ...
              <table class="table table-striped table-advance table-hover">
                ...
                @foreach($rvConf as $r)
                  ...
                  <tr>
                    ...
                    <td> {{ $r->dateRV }} </td>
                    <td> {{ $r->heureRV }} </td>
                    <td style="background-color:#00FF00"> {{ $r->etat }} </td>
                    <td>
                      ...
                      <!--<button class="btn btn-danger btn-xs">-->
                        ...
                        <a class="btn btn-danger btn-xs" title="Oups!!! button de supression..." onclick="return confirm('Ëtes-vous sûre de vouloir supprimer ce rendez-vous')" 
                            href="{{ url('destroyRvConf',$r->numRDV) }}" role="button">  
                            Supprimer
                        </a> 
