        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" method="POST" action="{{ url('storeRv') }}">
                ...
                <div class="form-group ">
                  <div class="col-lg-10">
                    <input class=" form-control" type="hidden" id="user_id" name="user_id" value="{{ $idd }}">  
                  </div>
                </div>
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class="form-control " id="today" name="dateRv" type="date" required />
                    </div>
                  </div>
