	...
	<!-- Fin menu bg-info-->
		...
		<div class="app-main__outer">
			<div class="app-main__inner">
				<div class="app-page-title bg-info">
					<div class="page-title-wrapper">
						<div class="page-title-heading">
							<div class="page-title-icon">
								<i class="{{ $icone }}"></i>
							</div>
							<div style="color: #FFFFFF">{{ $title }}
								<div class="page-title-subheading"> *Pour consulter un patient cliquer sur le boutton consulter	</div>
							</div>	
						</div>
					</div>
				</div>
